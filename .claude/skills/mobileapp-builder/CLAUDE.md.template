...
4. Read the spec file at `specs/<US-ID>.md` for detailed instructions
...
2. All checks in `specs/<US-ID>.md` pass
3. git commit clean
...
| Python/Pillow/sips for screenshots | Only `asc screenshots frame` |
