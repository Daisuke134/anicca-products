...
| 20-BP15 | **Onboarding は 30-second win を最初に出す**。最初の画面で core value を actionable に示し、長い tutorial / 強制 account / setup を避ける。Source: https://x.com/i/status/1895820573185622512 — 「Skip long tutorials, mandatory accounts, or setups. Make the first screen actionable.」 |
| 20-BP16 | **Weekly を primary に置く**。Weekly plan は revenue の中心にし、free trial は 7日を優先する。Source: https://x.com/i/status/2042561310236303382 — 「Weekly subscriptions now generate 55.5% of all app revenue」 |
| 20-BP17 | **Hard paywall を default 候補にする**。freemium より高CVR/高LTV を狙う。Source: https://x.com/i/status/2044400610334613944 — 「hard paywalls convert 5x better than freemium」 |
