...
| 20.1 | **Consistent Messaging**: 広告・オンボーディング・ペイウォールで同じトーン・ビジュアル・約束を使うこと。Source: https://blog.funnelfox.com/effective-paywall-screen-designs-mobile-apps/ — 「Consistent messaging from ad to onboarding to paywall increases conversions」 |
| 20.2 | **Benefit-Driven CTA**: "Subscribe" ではなく "Start my plan" / "Unlock full access" を使うこと。Source: https://blog.funnelfox.com/effective-paywall-screen-designs-mobile-apps/ — 「Benefit-driven CTAs ("Start my plan") outperform generic ones ("Subscribe")」 |
| 20.3 | **Clear Pricing with Anchor**: 月額・年額・トライアルを全て表示。年額プランに「Save 50%」表示。推奨プランを視覚的に強調。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Show all pricing options up front. Use anchor pricing and discounts: Highlight the savings for annual plans (e.g., "Save 50%")」 |
| 20.4 | **Trial as a Benefit**: "Start 7-day trial" ではなく "Try all premium features free for 7 days" を使うこと。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Reinforce the trial as a benefit, not a delay」 |
| 20.5 | **Progressive Disclosure**: Value説明画面 → Feature比較 → 価格表示の順にステップを分ける（一度に全て見せない）。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Progressive disclosure: Duolingo eases users in with an initial value screen, then shows feature comparisons and trial info before revealing the price, reducing overload and increasing commitment」 |
| 20.6 | **Social Proof**: ペイウォールに「Trusted by X users」「App Store rating」「Featured on [Media]」を含めること（可能な場合）。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Awards, app store ratings, "Trusted by 5M+ users" badges, or expert endorsements all help build confidence and reduce hesitation」 |
| 20.7 | **Risk Removal**: 「Cancel anytime」「No commitment」を価格表示・CTA近くに配置すること。Source: https://blog.funnelfox.com/effective-paywall-screen-designs-mobile-apps/ — 「Use clear language ("Cancel anytime"). Keep layouts clean; place trust signals near pricing and CTA」 |
| 20.8 | **3-Second Rule for Value Prop**: ペイウォールの価値提案は3秒で理解できること。冗長なコピーは削除。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Use the 3-second rule - if a user can't understand what they're getting within 3 seconds, your copy is too complex」 |
| 20.9 | **Visual Plan Highlighting**: 年額プランに「Most Popular」「Best Value」「Save XX%」タグを付け、視覚的に優位に配置すること。Source: https://adapty.io/blog/the-10-types-of-mobile-app-paywalls/ — 「Adding visual cues like "most popular" or "best-selling" labels on the plans you want to promote skew your users' decision」 |
| 20.10 | **Optimal Plan Count**: 価格プランは3つ（週次・月次・年次 or 月次・四半期・年次）が最も収益性が高い。Source: https://adapty.io/blog/the-10-types-of-mobile-app-paywalls/ — 「It's pretty clear that the most profitable paywall is a combination of 3 products」 |
| 20.11 | **Savings Percentage Display**: 年間プランに「Save 82%」等の具体的な割引率を明示すること（計算例: 月額 $15.99 vs 年額 $35.88 = $2.99/月 → 82% off）。Source: https://adapty.io/blog/the-10-types-of-mobile-app-paywalls/ — 「The "Save 82%" tag is difficult to miss」 |
| 20.12 | **Above-the-Fold Pricing**: 価格とCTAボタンはスクロール不要の位置（above the fold）に配置すること。Source: https://apphud.com/blog/design-high-converting-subscription-app-paywalls — 「Keep important info above the fold. Don't make users scroll to see pricing or the CTA」 |
