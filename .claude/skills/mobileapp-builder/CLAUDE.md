...
| 20-BP1A | **30秒以内に即効価値を見せる**。最初の30秒で成果が見えないユーザーは落ちるので、長いチュートリアルより先にコア体験を触らせる。Source: https://x.com/i/status/1895820573185622512 — 「most users drop off in the first 30 seconds if they don't see immediate value」 |
...
| 20-BP15 | **最初の 30 秒で core value を見せる**。長い tutorial や carousel は省き、オンボーディング冒頭で「成功した感覚」を先に出す。Source: https://x.com/i/status/1895820573185622512 — 「Deliver a "30-Second Win" First: Skip long tutorials or carousels—users ignore them. Let them interact with core features immediately.」 |
| 20-BP16 | **paywall は value の直後に置く**。価値体験の直後に hard paywall を出すと sunk cost が効く。Source: https://x.com/i/status/1989798727586922547 — 「Hit paywall after value (hard paywall post-investment leverages sunk cost).」 |
| 20-BP17 | **pricing は weekly + annual を軸に始める**。weekly は test entry、annual は value anchor。trial は 3-7 日の短期で始める。Source: https://x.com/i/status/1907063908122099838 — 「3-7 day full-feature trial → weekly ($2-10, easy test) or annual (best value, e.g., $49/year)」 |
| 20-BP20 | **Day 0 の最初の 30 秒でコア価値を見せる**。長い tutorial / carousel は省き、最初の 30 秒で value を体験させてから paywall に進める。Source: https://x.com/i/status/1895820573185622512 — 「Deliver a "30-Second Win" First: Skip long tutorials or carousels—users ignore them.」 |
| 20-BP18 | **価格は競合 top 3 を見て launch する**。高評価競合より 1 ドル低く始め、レビュー後に再調整する。Source: https://x.com/i/status/2042539585029214697 — 「Analyze top 3 competitors' prices/ratings. Undercut high-rated ones by $1 at launch; raise after 100 reviews if >4.2 stars.」 |
| 20-BP19 | **A/B は onboarding と paywall をまとめて継続改善**。2-3 flows と 4-5 paywalls まで検証する前提で設計する。Source: https://x.com/i/status/2042675831126814906 — 「Test 2-3 flows + 4-5 paywalls via A/B.」 |
