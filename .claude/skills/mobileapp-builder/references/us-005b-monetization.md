...
5. **Pre-paywall priming必須**。paywall表示前にアプリの価値を体感させる。90%がhard paywallでバウンスするが、pre-paywall体験が成功を左右する。Health appsでは早期permission取得で35% trial-to-paid向上。Source: https://x.com/i/status/2036997729528791271
