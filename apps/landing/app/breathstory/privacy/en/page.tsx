...
export default function BreathStoryPrivacyEN() {
  return (
    <main className="container mx-auto max-w-3xl px-4 py-24">
      ...
      <p className="mt-3 text-muted-foreground">
        To remove all data: delete BreathStory from your device. For support-related data deletion, contact support@aniccaai.com. Requests will be handled within a reasonable period.
      </p>
      ...
      <p className="mt-3 text-muted-foreground">
        For questions or concerns about this policy, contact: support@aniccaai.com
      </p>
