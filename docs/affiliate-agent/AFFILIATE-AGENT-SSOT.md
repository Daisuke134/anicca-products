...
| F0 current-Mac bootstrap | Browser capability sub-slice GREEN and installed disabled at `1f487bc877adcc00ed597cdd39e88bb81307272d`; pinned runtime and authority admission remain open | Browser inventory 3/3, bootstrap 3/3, authority 2/2, profile isolation 2/2, and R0 regression 3/3 pass. The immutable release inventoried CloakBrowser Chromium `145.0.7632.109` twice without launching it; receipt SHA is `9b4ca7ffc18dc10b83576c812d7c6805ed444e0b685287f7e0cd29f5a2d92f4c`, binary SHA is `79ddf7e7a7be8087319390ed79266387f6499b8a2e45ccfbaa724d7e7fff6b79`, current release matched, and Affiliate launchd count stayed zero. Generic executable READY admission is fail-closed rather than joining an unproven runtime version to a mutable path. The default manifest still contains no invented download; pinned Python runtime, Keychain readback, authorized-session discovery, and account-handle proof remain open |
