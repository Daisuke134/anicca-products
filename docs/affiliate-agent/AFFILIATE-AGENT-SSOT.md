...
| F0 current-Mac bootstrap | Browser and pinned-runtime sub-slices GREEN; disabled immutable release is `eb1df8c05c5b1eb73ed8a20ad93000abace6e139`; authority admission remains open | CloakBrowser Chromium `145.0.7632.109` was inventoried without launching it. PBS CPython `3.14.7+20260814` was downloaded from its fixed URL, matched artifact SHA `423717c485b9ee7822590b9d973c1b5fb2cda0fe43448ab82a3d44f823bd329c`, extracted from the same held file descriptor, tree-verified, and atomically activated. Python `3.14.7`, OpenSSL `3.5.7`, and SQLite `3.53.1` passed live. Repeated normal and hostile-environment runs kept receipt SHA `5677a0ecfc6d648fa8595856a29597231493891701355b22d8b37f8c3d4f757a` and tree SHA `bcf2489a4b32fc9cd76b0845aa7c05a7b030c088177048f55d78ae5e8a290243` unchanged. Affiliate launchd count stayed zero. Keychain readback, authorized-session discovery, and account-handle proof remain open |
