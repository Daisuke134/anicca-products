                    ...
                    HStack{
                        Button("Start Restrictions") {
                            if(MyModel.shared.selectionToDiscourage.applicationTokens.count == 0 && MyModel.shared.selectionToDiscourage.categoryTokens.count == 0) {
                                ...
                                UserDefaults(suiteName:"group.ai.anicca.screenbreak")!.set(true, forKey:"widgetInRestrictionMode")
                                ...
                                case "15 mins":
                                    ...
                                    UserDefaults(suiteName:"group.ai.anicca.screenbreak")!.set(endTime[0], forKey:"widgetEndHour")
                                    UserDefaults(suiteName:"group.ai.anicca.screenbreak")!.set(endTime[1], forKey:"widgetEndMins")
                                case "30 mins":
                                ...
                                case "Rest of Day":
                                    ...
                                    UserDefaults(suiteName:"group.ai.anicca.screenbreak")!.set(23, forKey:"widgetEndHour")
                                    UserDefaults(suiteName:"group.ai.anicca.screenbreak")!.set(59, forKey:"widgetEndMins")
                                default:
