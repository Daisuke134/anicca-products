...
| 8f | CORE-c | context/onboarding/discovery: 初回user、既存user、location未解錠/解錠後、同じclosed Qを二度聞かないことを再検証 | eval 100% + 実TG callback + DB/context provenance。質問禁止領域の発話0件 | **pending — code/schema/release PASS、controlled production L3中**。accepted base=`85a68abaa`、journey RED=`90933cbb9`、corrective endpoint/UI RED=`0fc453527`、GREEN=`771f996c9`。fixed context eval=`12/12 (100%)`、実production `/telegram` handlerのcallback/replay/cross-tenant contract、onboarding user-scoped resume、calendar signed connect、full Life Call test/evalはいずれもfail 0。PR #338 merge/origin-dev=`a4e3ae9c62ffeadcfe328298df13b03658946f1b`、staging deployment=`bcd237d9-590b-49e4-9ada-cdebcfa54beb` exact SHA SUCCESS。additive migrationはtransaction適用し、ask追加column=`7/7`、location source=`1/1`、nonce table/index、RLS、forbidden grants=`0`、service DML=`4/4`をpostflight。PR #339を通常mergeし、merge/origin-main=`47d0f143e33fa6301d141ccc95529002fa9feb59`、Railway production deployment=`b0e75e9f-c48e-46dd-9ed7-2fde96323651` exact SHA SUCCESS。次はDais本人の実TG closed Q→MTProto callback→DB/context provenance、semantic duplicate 0、forbidden questions 0、baseline復元をL3実測する | pending |
