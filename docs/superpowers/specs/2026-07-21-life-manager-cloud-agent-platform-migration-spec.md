...
| 2 | loopごとのcredential inventoryを作る | secret値なしでprovider/scope/refを記録 | in_progress — 395 parent / 399 edge candidate。新financial-report+payoutはunverified、旧393 tuple reject、170/170。fresh review待ち |
