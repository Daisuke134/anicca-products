...
| 2 | loopごとのcredential inventoryを作る | secret値なしでprovider/scope/refを記録 | in_progress — 396 parent / 400 edge candidate。新weekly-reportはunverified、旧395 approval reject、fresh review待ち |
