...
| 29 | 395-parent rebind candidate | re-review_required | live追加されたfinancial-reportとpayoutを含む395 parentへ再収集。親 `sha256:f56ddbe1:e3c71ae5:307f8f50:1a31bea5:1c11296b:242d3c60:38bd5b5e:3c9d8d1d`、observation `sha256:fa6e3f93:b0e574b4:f561a4a5:3e754e41:3cc85c52:3b7d7bc3:405a465c:c06956e7`、candidate manifest `sha256:b407b30c:cdef984f:e8d14e64:ec262174:d80283f7:55010142:519b9fe1:13c58d98`、object `sha256:4643e2ab:5cbc30cd:ae740a23:d3ff2d91:46640a76:fe09cee2:1f60587d:30fd31ca`、inventory `sha256:ca3af8fe:763756ce:42ee2c5c:3e6d193f:68058906:e493f689:7bc3717b:7e8b2bc5`へexact bindする。395 parent / 399 edge / 18 credential object / finding 1、statusはnone_observed 35 / observed 10 / unverified 354。新2親はrevision-bound `unverified / independent_review_pending`、旧393 approval tupleはcurrent artifactsでもrejectする。RED 11 failure / 6 errorからcandidate 170/170 GREEN、collector A/Bは全nested `observed_at`を除き一致、candidate tracked byte exact、normal no-output fail-close。builder/separate reviewはpendingで、fresh independent review前は`in_progress`を維持する |
| 29 | 395-parent first fresh review | reject | 395 exact coverage、399 edge、new parent unverified、5 digest bind、170/170、gitleaksは承認対象。blockerはrepository 4親のtop-level revisionが検査対象blobでなくrepo全体HEAD/treeへbindし、artifact commit `abd6d0203` 自身によりtracked observationが即staleになったこと。無関係commitで変化しないpackage/source-closure bound revision contractへ修正し、fresh re-review前は`in_progress`を維持する |
| 29 | repository revision self-invalidation remediation | re-review_required | unrelated HEAD/tree値を返すfake runnerに対してpackage blobだけを要求し、locatorからcommit/treeを排除するtargeted RED→GREEN。top-level repository revisionはexact package blob、credential source closureは既存per-source blob `reference_evidence`へ分離する。fallback tree digestも廃止する。再収集後の395 candidateはobservation `sha256:fa6e3f93:b0e574b4:f561a4a5:3e754e41:3cc85c52:3b7d7bc3:405a465c:c06956e7`、manifest `sha256:b407b30c:cdef984f:e8d14e64:ec262174:d80283f7:55010142:519b9fe1:13c58d98`、inventory `sha256:ca3af8fe:763756ce:42ee2c5c:3e6d193f:68058906:e493f689:7bc3717b:7e8b2bc5`へrebindする。fresh re-review前は`in_progress`を維持する |
| 29 | 395-parent final independent re-review | approved | fresh reviewer verdictは`ok:true / blocking:[] / todo2_395_rebind_independent_review_approved_v1 / independent_fresh_credential_reviewer`。remediation commit後のcollector再実行が全nested `observed_at`を除きtrackedと一致し、package blob / source-closure blob分離、395 / 399、新2親unverified、170/170、candidate tracked exact、normal no-output、6 artifact gitleaks、旧393 tuple rejectionを独立確認する。builder manifestはpendingを維持し、separate reviewだけをapprovedへ遷移する |
| 30 | 395-parent hf-gig metadata rebind candidate | re-review_required | final live gateでhf-gigのtrigger `calendar_entries=2→1`を検知。件数/IDは395で不変だが旧approvalを流用しない。current parent `sha256:f35d7ec8:a121a760:cd9e7488:195b7b2a:1f9f5ecc:7af13ab8:1bb5671e:73163db9`、observation `sha256:a367c5bc:7785d848:44c51904:8b7509fa:26722f52:298599d3:86364882:303d37e3`、manifest `sha256:c8182e7b:41b8e858:1c884007:9117edbd:01930bed:f43811ce:a25b7987:da153152`、object `sha256:4643e2ab:5cbc30cd:ae740a23:d3ff2d91:46640a76:fe09cee2:1f60587d:30fd31ca`、inventory `sha256:7e429fba:a6d5a2c5:ef208d5e:e681559c:947bcc00:56a1309a:056a0691:8695f586`へrebindする。hf-gigだけをrevision-bound unverifiedへ戻し、builder/separate reviewはpendingを維持する |
| 31 | 396-parent weekly-report rebind candidate | re-review_required | live追加されたhf-gig-weekly-reportを含む396 parentへ再収集。親 `sha256:61482ba7:96818eeb:89aecc35:ad3c4366:f81d3625:9258d8f8:4e65e542:11f86872`、observation `sha256:b21ecd7c:3d68d099:e29dceba:05dc4fa3:b3dab4e0:acb984b3:09f3c0bd:653a3e4e`、manifest `sha256:76a7c770:b4aff378:d4b4c85c:3f919259:b819c5f6:3dd0d96b:da64ce77:5a4d03f8`、object `sha256:4643e2ab:5cbc30cd:ae740a23:d3ff2d91:46640a76:fe09cee2:1f60587d:30fd31ca`、inventory `sha256:953516fe:304385e2:227da851:fb64dd10:10e9e106:b836464b:4c8e463b:fd995672`へexact bindする。396 parent / 400 edge、status none_observed 35 / observed 10 / unverified 355、新親はrevision-bound unverified、builder/separate reviewはpendingを維持する |
| 31 | 396-parent final independent review | approved | fresh reviewer verdictは`ok:true / blocking:[] / todo2_396_rebind_independent_review_approved_v1 / independent_fresh_credential_reviewer`。live/tracked 396、post-commit collector equality、400 edge、新weekly-report unverified、package/source-closure revision分離、candidate tracked exact、normal pending no-output、旧395 tuple rejection、170 credential test / 175 combined、6 artifact gitleaksを独立確認する。builder manifestはpendingを維持し、separate reviewだけをapprovedへ遷移する |
...
396-parent final independent re-review evidence: `ok:true / blocking:[] / todo3_396_rebind_independent_review_approved_v1 / independent_fresh_state_artifact_reviewer`。builder manifestはpendingを維持し、separate reviewだけをapprovedへ遷移する。normal observation/edge/object A=B=tracked、31/31、Python compile、6 artifact exact gitleaks、live parent exact、diff checkをfresh再検証し、396 / 2,376 / 396 / 2,772 / 189、coverage discovered 4 / unverified 2,372、shared 1 / 222、unbound 6、追加3 loopの6 category unverifiedを維持するためTODO #3を`done`とする。
...
396-parent final independent re-review evidence: first reviewはSSOT Contractの旧393表記1点をrejectし、current contractを396へ是正後のfresh re-reviewは`ok:true / blocking:[] / todo4_396_rebind_independent_review_approved_v1 / independent_fresh_external_effect_reviewer`。builder manifestはpendingを維持し、separate reviewだけをapprovedへ遷移する。normal observation/edge/object A=B=tracked、17/17、Python compile、6 artifact exact gitleaks、live parent exact、diff checkをfresh再検証し、396 / 1,980 / 6 / 1,986 / 12、coverage discovered 6 / unverified 1,974、call 1 / mail 1 / post 3 / render 1 / wallet 0、新3 loop全category unverified、wallet blockedを維持するためTODO #4を`done`とする。
...
- [x] deterministic tracked byte exact、privacy、secret scan、fresh review、pushを完了する。
...
396-parent final fresh review evidence: `ok:true / blocking:[] / todo5_396_macos_dependency_review_approved_v1 / independent_fresh_macos_dependency_reviewer`。396 / 396 exact opaque coverage、Linux-ready 1 / replacement-required 395 / retire 0、launchd 169 / OpenClaw 222 / repository 4 / Railway 1の分類と追加3 launchd loopのreplacement-requiredを独立確認する。A=B=tracked、5/5、Python compile、TSV+doc exact gitleaks 2/2、live parent exact、diff check、raw parent ID 0、duplicate parent no-output fail-closeがPASSするためTODO #5を`done`とする。

### 6.5.2 TODO #6 TaskList — workload queue classification

- [x] 5 queueのisolation / concurrency keyを§3.4のexact contractへ固定する。
- [x] current 396 parentとTODO #4 reviewed external-effect inventoryをopaque ref + parent digestで結合する。
...
TODO #2 final gate中にparent件数/IDは395のまま、`launchd:ai.anicca.hf-gig-pass`のlive schedule metadataが`calendar_entries=2`から`calendar_entries=1`へ変化した。A/Bで同じcurrent値を確認し、loopを停止・再起動せずtracked parentを更新する。complete ID digestは不変、ordered parent metadata digestは`sha256:f35d7ec8:a121a760:cd9e7488:195b7b2a:1f9f5ecc:7af13ab8:1bb5671e:73163db9`。旧395 metadata revisionへbindしたTODO #2〜#6はcurrent completionへ流用しない。

続くcurrent gateでlive `launchd:ai.anicca.hf-gig-weekly-report`を追加検知した。Mac Miniを停止せずA/B収集し、current parentは396 row（launchd 169 / OpenClaw cron 222 / Railway 1 / repository 4）、complete ID digest `5cb597d26321089ed678fb8c48a85599734d0709c2d5d69166c37b5cb75967e0`、ordered parent metadata digest `sha256:61482ba7:96818eeb:89aecc35:ad3c4366:f81d3625:9258d8f8:4e65e542:11f86872`となる。395から追加1 / 削除0。旧395 approvalはcurrent completionへ流用しない。
