...
> Generated from `/Users/anicca/anicca/skills/self/colony-status.sh` at `2026-07-21T18:09:00Z`. This is measured output, not a self-report.

```text
════════════ ANICCA COLONY — LIVE SSOT (2026-07-21T18:08Z) ════════════
...
[3] claude-p (me)   human-funded (this Claude → PM earner)     HOME=~/.anicca-founder
    ...
    PM positions: 1 open, value $6.86, unrealized P&L $+1.317
