...
> Generated from `/Users/anicca/anicca/skills/self/colony-status.sh` at `2026-07-21T17:38:54Z`. This is measured output, not a self-report.

```text
════════════ ANICCA COLONY — LIVE SSOT (2026-07-21T17:38Z) ════════════
...
[3] claude-p (me)   human-funded (this Claude → PM earner)     HOME=~/.anicca-founder
    ...
    PM positions: 1 open, value $7.03, unrealized P&L $+1.490
