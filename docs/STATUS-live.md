...
> Generated from `/Users/anicca/anicca/skills/self/colony-status.sh` at `2026-07-22T21:09:03Z`. This is measured output, not a self-report.

```text
════════════ ANICCA COLONY — LIVE SSOT (2026-07-22T21:08Z) ════════════
...
[3] claude-p (me)   human-funded (this Claude → PM earner)     HOME=~/.anicca-founder
    ...
    PM positions: 1 open, value $6.16, unrealized P&L $+0.625
