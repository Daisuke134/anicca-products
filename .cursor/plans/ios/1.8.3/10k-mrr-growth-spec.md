...
#### ~~STEP 9: Value Delivery~~ — SKIPPED（ダイス指示 2026-04-09）

**スキップ理由:** シェアカード + UIActivityViewController は不要。AppDemo → 直接 Notifications へ遷移。
...
| # | タスク | 担当 | 依存 | 状態 |
|---|--------|------|------|------|
| **T13** | **ASC でトライアル削除（annual+monthly）** | **ダイス** | READY_FOR_SALE後 | ⏳ 提出後 |
