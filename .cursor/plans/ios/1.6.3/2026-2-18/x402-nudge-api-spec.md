...
│ paymentMiddleware の declareDiscoveryExtension() で登録  │
...
| ~~9~~ | ~~`.well-known/x402.json` を Express に追加~~ — **削除。どのスキルにも記載なし** |
...
| 項目 | 値 |
|------|-----|
| **SKILL.md** | Mac Mini `/Users/anicca/.openclaw/skills/x402-skill-marketer/SKILL.md` |
